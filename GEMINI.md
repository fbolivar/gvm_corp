...
### 2026-02-23: Búsqueda Maestra y Sugerencias IA
- **Error**: La coincidencia de texto simple (`ILIKE`) falla con tildes y errores tipográficos, frustrando la experiencia de búsqueda rápida. Además, componentes globales como el buscador pueden quedar ocultos tras otros overlays.
- **Fix**: 
    1. Implementar **PostgreSQL FTS** con configuración `unaccent` para ignorar tildes nativamente. 
    2. Usar `pg_trgm` vía RPC para habilitar funcionalidad "Did you mean?" con alta performance.
