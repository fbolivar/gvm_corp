...
import { User, Save, Camera, Mail, ShieldCheck, BadgeCheck } from "lucide-react";
                    ...
                    <Card className="border-none bg-white shadow-premium rounded-[2.5rem] overflow-hidden h-full">
                        ...
                        <CardContent className="p-10 pt-0 space-y-8">
                            ...
                            <div className="pt-8 border-t border-slate-50">
                                <Button variant="outline" className="h-12 px-6 rounded-xl border-none bg-slate-50 text-slate-500 font-bold hover:bg-slate-100 transition-all">
                                    Cambiar Contraseña
                                </Button>
                            </div>
                        </CardContent>
