        ...
        <div className="space-y-0">
            ...
            {filteredQuotations.length === 0 ? (
                <div className="py-16 text-center">
                    ...
                    <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Sin cotizaciones registradas</p>
                </div>
            ) : (
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {filteredQuotations.map((quote) => (
                                <TableRow key={quote.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-semibold text-slate-900">
                                                    {quote.party?.legal_name || 'Consumidor Final'}
                                                </p>
                                                <span className="text-[10px] text-slate-400 font-medium">#{quote.number}</span>
                                            </div>
                                        </div>
                                    </TableCell>
                                            ...
                                            {quote.status === 'DRAFT' && (
                                                ...
                                                >
                                                    {processingId === quote.id
                                                        ...
                                                        : <><ShoppingCart className="h-3.5 w-3.5" /> Pedido</>
                                                    }
                                                </Button>
                                            )}
