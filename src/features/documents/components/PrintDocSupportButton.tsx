...
/**
 * Abre popup centrado que auto-imprime el Documento Soporte (formato DIAN).
 */
export function PrintDocSupportButton({ docId }: { docId: string }) {
  const handlePrint = () => {
    const url = `/print/doc-support?id=${docId}`;
    const width = 900;
    const height = 1100;
