    ...
    const sidebarLinks: SidebarGroup[] = [
        {
            ...
            links: [
                ...
                { title: t.sidebar.parties, href: "/parties", icon: Users },
                { title: t.sidebar.my_payroll, href: "/my-payroll", icon: Banknote },
            ]
        },
        {
            ...
            links: [
                ...
                { title: t.sidebar.reports, href: "/documents", icon: Receipt },
                { title: t.sidebar.production, href: "/production", icon: Factory },
                {
                ...
                { title: t.sidebar.logistics, href: "/logistics", icon: Truck },
            ]
        },
        {
            group: t.sidebar.tools.toUpperCase(),
            links: [
                { title: t.sidebar.collaboration, href: "/collaboration", icon: MessageSquare },
                { title: t.sidebar.settings, href: "/settings", icon: Settings },
                { title: t.sidebar.help, href: "/help", icon: HelpCircle },
            ]
        }
    ];
            ...
            try {
                ...
                if (user) {
                    ...
                    if (userTenant) {
                        ...
                        setRole(roleMap[userTenant.role] || userTenant.role);
                    }
                }
            } catch (error) {
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-60 mb-3 bg-white border-slate-100 text-slate-900 rounded-2xl p-2 shadow-2xl" side="top" align="start" forceMount>
                                ...
                                <DropdownMenuGroup className="p-1.5 space-y-0.5">
                                    ...
                                    <DropdownMenuItem onClick={() => window.location.href = '/settings'} className="rounded-xl focus:bg-slate-50 focus:text-indigo-600 cursor-pointer py-2.5">
                                        <Settings className="mr-2.5 h-3.5 w-3.5 text-indigo-600" />
                                        <span className="text-[10px] font-black uppercase tracking-widest italic">Ajustes Globales</span>
                                    </DropdownMenuItem>
                                </DropdownMenuGroup>
                                <DropdownMenuSeparator className="bg-slate-100" />
