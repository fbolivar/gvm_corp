        ...
        <div className="space-y-12 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-1000 container mx-auto py-12 px-4">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 px-1">
                <div className="space-y-2">
                    ...
                    <h1 className="text-5xl font-black tracking-tighter text-slate-900 italic">Contratación</h1>
                    <div className="flex items-center gap-4">
                        <p className="text-slate-400 font-bold text-sm uppercase tracking-widest">Alta de nuevo capital humano</p>
                        <div className="flex items-center gap-2 bg-indigo-50 px-3 py-1 rounded-full">
                            <UserPlus className="h-3 w-3 text-indigo-600" />
                            <span className="text-[10px] font-black text-indigo-600 uppercase tracking-widest">Registro Oficial</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-white p-2 rounded-[1.5rem] shadow-premium border-none">
                    ...
                    <div className="pr-4">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Onboarding V3</p>
                        <p className="text-sm font-black text-slate-900 italic">Proceso Automatizado</p>
                    </div>
                </div>
            </div>
