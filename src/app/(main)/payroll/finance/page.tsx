...
import { PayrollFinanceContent } from "@/features/payroll/components/PayrollFinanceContent"
        ...
        <div className="page-container space-y-6 pb-20 animate-in fade-in duration-500">
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    <VisualReportHeader
                        title="Finanzas HCM"
                        subtitle="Libranzas, prestamos y auxilios extralegales"
                        tenant={tenant}
                    />
                </div>
            </div>

            <PayrollFinanceContent />
        </div>
    )
}
