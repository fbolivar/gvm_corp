...
export default async function AbsencesPage() {
    ...
    const kpis = [
        ...
        { label: 'Dias Aprobados', value: `${totalDaysApproved}d`, icon: CalendarDays, color: 'text-slate-600', bg: 'bg-slate-50' },
    ];
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    <VisualReportHeader
                        ...
                        subtitle="Gestion de solicitudes, aprobaciones e historial"
                        tenant={tenant}
                    />
                </div>
            </div>
