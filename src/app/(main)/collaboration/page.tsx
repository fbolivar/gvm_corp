...
export default async function CollaborationPage() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 pb-12">
            {/* PREMIUM HEADER */}
            <div className="relative overflow-hidden bg-slate-950 rounded-[2.5rem] p-10 text-white shadow-active border border-white/5 group">
                {/* Decorators */}
                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <div className="flex items-center gap-3 pt-2">
                        ...
                        <Badge className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[9px] font-black uppercase tracking-[0.3em] px-4 py-2 rounded-full">
