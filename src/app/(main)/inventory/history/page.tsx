...
import { History, ArrowLeft, Download, ShieldCheck } from 'lucide-react';
        ...
        <div className="space-y-12 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 px-1">
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2 bg-slate-900 px-3 py-1 rounded-full">
                            ...
                            <span className="text-[10px] font-black text-white uppercase tracking-widest italic">Actividad Protegida</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Button variant="outline" className="h-14 w-14 p-0 rounded-2xl border-none bg-white shadow-premium text-slate-400 hover:text-primary transition-all active:scale-95">
