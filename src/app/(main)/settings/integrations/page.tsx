...
export default async function IntegrationsPage() {
    ...
    try {
        ...
        if (!tenantInfo) {
            return <div className="p-12 text-center text-slate-500 font-bold uppercase tracking-widest italic border-2 border-dashed border-slate-100 rounded-[2.5rem] m-8">
        ...
        return (
            <div className="m-8 p-12 bg-rose-50 border-2 border-rose-100 rounded-[2.5rem] text-rose-600 space-y-4">
