    ...
    return (
        <div className="space-y-16 pb-32 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-6">
                <div className="bg-white p-10 rounded-[2.5rem] shadow-premium border border-slate-50 flex flex-col gap-8 group hover:-translate-y-3 transition-all duration-700 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start">
                        ...
                        <Badge variant="outline" className="border-slate-100 text-slate-400 font-black text-[10px] tracking-[0.4em] px-4 py-1 rounded-full uppercase leading-none mt-2">Nominal</Badge>
                    </div>
                    <div className="space-y-2">
                        <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.5em] leading-none">Capital en Negociación</p>
                ...
                <div className="bg-white p-10 rounded-[2.5rem] shadow-premium border border-slate-50 flex flex-col gap-8 group hover:-translate-y-3 transition-all duration-700 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start">
                        ...
                        <Badge className="bg-emerald-50 text-emerald-600 border border-emerald-100 font-black text-[10px] tracking-[0.4em] px-4 py-1 rounded-full animate-pulse">ALTO DESEMPEÑO</Badge>
                    </div>
                    <div className="space-y-2">
                        <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.5em] leading-none">Tasa de Exito</p>
                        <h3 className="text-4xl font-black text-slate-950 tracking-tight leading-none">{winRate.toFixed(1)}%</h3>
                    </div>
                    <div className="h-2 w-full bg-slate-50 rounded-full overflow-hidden shadow-inner border border-slate-100/50">
                ...
                <div className="bg-slate-950 p-10 rounded-[2.5rem] shadow-active border border-white/5 flex flex-col gap-8 group hover:-translate-y-3 transition-all duration-700 relative overflow-hidden text-white">
                    ...
                    <div className="space-y-4">
                        ...
                        <h4 className="text-3xl font-black text-white tracking-tight uppercase leading-tight">Mesa de Comando <br /><span className="text-indigo-400">Sincronizada</span></h4>
                    </div>
                    ...
                    <div className="flex items-center gap-10 relative z-10 text-center lg:text-left flex-col lg:flex-row max-w-4xl">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 justify-center lg:justify-start">
                                ...
                                <h4 className="text-3xl font-black tracking-tight uppercase leading-tight text-white">Certificación de Pipeline Comercial</h4>
                            </div>
