        ...
        <div className="page-container space-y-16 pb-32 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3 px-1">
                    ...
                    <h3 className="text-xl font-black text-slate-900 tracking-tight uppercase">Bitácora de Suministros</h3>
                </div>
            ...
            <div className="bg-slate-900 p-10 rounded-[2.5rem] text-white flex flex-col lg:flex-row items-center justify-between gap-12 shadow-active relative overflow-hidden group">
                ...
                <div className="flex items-center gap-10 relative z-10 text-center lg:text-left flex-col lg:flex-row">
                    ...
                    <div className="space-y-3">
                        <h4 className="text-2xl font-black tracking-tight uppercase leading-tight text-white">Validación de Carga</h4>
