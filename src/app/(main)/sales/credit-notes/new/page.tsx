...
import CreditNoteFormClient from './client';
...
export default async function NewCreditNotePage() {
    ...
    // Fetch invoices that are ACCEPTED or SIGNED (eligible for credit notes)
    ...
    // Filter eligible invoices on the server
