        ...
        <div className="space-y-12 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-1000 max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 px-1">
                <div className="space-y-2">
                    <h1 className="text-5xl font-black tracking-tighter text-slate-900 italic">Nueva Cotización</h1>
                    <div className="flex items-center gap-4">
                        <p className="text-slate-400 font-bold text-sm uppercase tracking-widest">Crear Propuesta Comercial</p>
                        <div className="flex items-center gap-2 bg-amber-50 px-3 py-1 rounded-full">
                            <FileText className="h-3 w-3 text-amber-600" />
                            <span className="text-[10px] font-black text-amber-600 uppercase tracking-widest">Ventas</span>
                        </div>
                    </div>
                </div>
            </div>
            <NewQuotationClient parties={parties || []} products={products || []} />
        </div>
    );
}
