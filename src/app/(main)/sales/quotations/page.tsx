        ...
        <div className="page-container space-y-12 pb-24 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="relative group overflow-hidden bg-slate-950 rounded-[2.5rem] p-10 text-white shadow-active">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                    ...
                    <div className="flex gap-4">
                        ...
                        <Button asChild className="h-12 px-12 rounded-[2rem] bg-amber-600 hover:bg-amber-500 text-white font-black shadow-active transition-all hover:scale-105 active:scale-95 border-none">
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4 px-2">
                    ...
                    <h3 className="text-xl font-black text-slate-900 tracking-tight uppercase">Historial de Negociaciones</h3>
                </div>
            ...
            <div className="bg-slate-950 p-10 rounded-[2.5rem] text-white flex flex-col lg:flex-row items-center justify-between gap-12 shadow-active relative overflow-hidden group">
                ...
                <div className="flex items-center gap-10 relative z-10 text-center lg:text-left flex-col lg:flex-row">
                    ...
                    <div className="space-y-3">
                        <h4 className="text-2xl font-black tracking-tight uppercase leading-tight text-white">Validación de Preventa</h4>
